...
<div class="px-4 py-5 text-center">
    <div style="max-width:500px;margin:0 auto;background:#142C4C;border-radius:0.75rem;padding:2.5rem;border:1px solid rgba(255,255,255,0.06);">
        ...
        <a href="{{ route('company.plans.checkout', $plan->id) }}" class="btn btn-primary mt-3" style="background:#D4A017;border:none;color:#0B1D33;font-weight:700;">Tentar novamente</a>
    </div>
</div>
@endsection
