...
<div class="mt-3 pt-3 container">
    <h3 class="py-2">{{ $isEdit ? 'Editar Post' : 'Criar Post' }}</h3>

    {{ Form::open(['route' => $isEdit ? ['admin.posts.update', $data->id] : 'admin.posts.store', 'method' => $isEdit ? 'put' : 'post', 'files' => true]) }}
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <textarea name="content" id="postEditor" rows="15"
                          class="form-control @error('content') is-invalid @enderror">{{ old('content', $data->content ?? '') }}</textarea>
