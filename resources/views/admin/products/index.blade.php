...
<div class="mt-3 pt-3 container">
    @include('admin.partials.searchbar', ['title' => 'Produtos', 'route' => 'admin.products', 'model' => 'products'])
        ...
        @forelse($products as $item)
            ...
            <div class="col-6 col-sm-2 d-flex justify-content-center">
                <div class="btn-group btn-group-sm">
                    <a href="{{ route('admin.products.edit', $item->id) }}" class="btn btn-primary">Editar</a>
                    {{ Form::open(['route' => ['admin.products.destroy', $item->id], 'class' => 'confirmDelete d-inline']) }}
            ...
            <div class="col-12 p-0"><hr class="p-0 m-1"></div>
        @empty
            <div class="col-12 text-center py-4 text-muted">Nenhum produto encontrado.</div>
        @endforelse
    </div>
